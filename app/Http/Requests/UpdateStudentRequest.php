...
class UpdateStudentRequest extends FormRequest
{
    ...
    {
        $studentRouteParam = $this->route('student');
        $studentId = $studentRouteParam instanceof Student
            ? (string) $studentRouteParam->getKey()
            : (string) $studentRouteParam;
...
'birth_certificate_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg', 'max:2048'],
    ...
    protected function passedValidation(): void
    {
        Log::info('UpdateStudentRequest validation passed', [
            'student_id' => $this->route('student') instanceof Student ? $this->route('student')->id : $this->route('student'),
