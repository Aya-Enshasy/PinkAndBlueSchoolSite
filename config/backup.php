...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', env('APP_NAME', 'school-management')),
        ...
        'destination' => [
            ...
            'disks' => array_values(array_filter(array_map(
                ...
                explode(',', (string) env('BACKUP_DISKS', 'backup-local'))
            ))),
        ],
         ...
         */
        'tries' => (int) env('BACKUP_RETRY_ATTEMPTS', 3),

        /*
         * The number of seconds to wait before attempting a new backup if the previous try failed
         * Set to `0` for none
         */
        'retry_delay' => (int) env('BACKUP_RETRY_DELAY_SECONDS', 10),
    ],
